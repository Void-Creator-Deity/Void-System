<template>
  <div class="advisor-container">
    ...
    <!-- AI响应摘要 -->
    <div v-if="advisorResult.response" class="ai-response-section">
      <h3 class="section-title">🤖 AI 响应</h3>
  ...
  try {
    ...
    advisorResult.value = {
      query: userQuery.value,
       response: `基于您的目标"${userQuery.value}"，我已经为您生成了详细的任务计划。这个计划包括四个主要阶段，涵盖了从准备到评估的完整流程。`,
      steps: [
        {
          title: '准备阶段',
      ...
      estimatedDuration: '45分钟',  // 移除空格，保持与后端数据格式一致
      createdAt: new Date()
    }
