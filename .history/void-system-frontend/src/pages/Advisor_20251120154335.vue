...
.results-section {
  ...
  padding: 2rem;
  backdrop-filter: blur(15px);
  box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), 0 0 25px rgba(0, 204, 255, 0.1);
  position: relative;
  overflow: hidden;
...
@keyframes containerGlow {
  0% { box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), 0 0 20px rgba(0, 204, 255, 0.1); }
  100% { box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), 0 0 30px rgba(0, 204, 255, 0.2); }
}
...
.results-section:hover .timestamp {
  opacity: 1;
...
.start-task-btn:hover {
  box-shadow: 0 0 25px var(--accent-primary), 0 8px 25px rgba(0, 0, 0, 0.3);
